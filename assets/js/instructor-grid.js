/**
 * Created by MARIOWHITE on 4/5/2017.
 */
...
function showResultList(instructors, current_page, item_per_page, total_elements) {
    ...
    for (var i = 0; i < instructors.length; i++) {
        ...
        var content = '<!-- instructors-->' +
            ...
            '<a href="instructor-detail/' + instructors[i]['id_instructor'] + '">' +
        ...
        $('#instructors-grid').append(content);
