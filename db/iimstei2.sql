...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2017 at 08:24 PM
...
DROP TABLE IF EXISTS `atted`;
CREATE TABLE IF NOT EXISTS `atted` (
...
INSERT INTO `instructors` (`id_instructor`, `name`, `title`, `description`, `email`, `phone`, `address`, `photo`) VALUES
