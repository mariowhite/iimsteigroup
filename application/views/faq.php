		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<h1 class="page-title">Frequency Asked Questions (FAQ)</h1>
								...
								<div class="content-wrapper">
									...
									<div class="faq-wrapper">
										...
										<div id="faq-section-0" class="faq-section">
											...
											<div class="panel-group bootstarp-accordion" id="faq-accordion" role="tablist" aria-multiselectable="true">
												...
												<div class="panel">
													<div class="panel-heading" role="tab">
														<h4 class="panel-title">
															<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion" href="#faq-accordion-one-6" aria-expanded="false" aria-controls="faq-accordion-one-6">Why register with I use?</a>
														</h4>
													</div>
										...
										<div id="faq-section-3" class="faq-section">
											...
											<div class="section-title text-left mb-20">
												<h4>Legal Stuff for Your FAQ</h4>
											</div>
										...
										<div id="faq-section-4" class="faq-section">
											...
											<div class="section-title text-left mb-20">
												<h3>Copyright Law and Infringement </h3>
											</div>
