						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12_xss-12">
								...
								<div class="content-wrapper mb-10">
									...
									<div class="sorting-wrappper">
										...
										<div class="sorting-header">
											...
											<div class="row">
												...
												<div class="col-xss-12 col-xs-12 col-sm-5 col-md-3" id="search-button">
											...
											<div class="row">
												...
												<div class="col-xss-3 col-xs-3 col-sm-3">
													<div class="sort-by-wrapper for-layout-option">
														...
														<div class="sorting-middle-holder">
															<a href="<?php echo base_url(); ?>instructor-list" class="btn btn-sorting active"><i class="fa fa-th-list"></i></a>
															<a href="<?php echo base_url(); ?>instructor-grid" class="btn btn-sorting"><i class="fa fa-th-large"></i></a>
														</div>
													</div>
												</div>
									...
									<div class="teacher-item-list-wrapper mb-20" id="instructors-list">
